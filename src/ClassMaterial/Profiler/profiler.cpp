...
{
	profiler.AddProfileMark(ProfileMarker::MarkerType::BEGIN, 0, "Main"); // hem de marcar una tasca per a que el profiler funcioni.
	
	Update(profiler);
	
	profiler.AddProfileMark(ProfileMarker::MarkerType::END, 0, "Main");
}
